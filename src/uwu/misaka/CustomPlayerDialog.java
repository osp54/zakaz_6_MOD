...
public class CustomPlayerDialog extends PlayerListFragment {
            ...
            if((net.server() || player.admin) && !user.isLocal() && (!user.admin || net.server())){
                ...
                button.table(t -> {
                    ...
                    t.button(Icon.hammer, Styles.clearPartiali,
                            () -> ui.showConfirm("@confirm", Core.bundle.format("confirmban",  user.name()), () -> Call.sendChatMessage("/ban "+user.uuid())));
